package com.zukisu.ultra.magica;

import static com.zukisu.ultra.magica.AppZygotePreload.TAG;
...
import com.zukisu.ultra.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.zukisu.ultra.magica.LAUNCH".equals(action)) {
            return;
        }

package com.zukisu.ultra.ui.kernelFlash.util
...
class RemoteToolsDownloader(
    ...
    companion object {
        ...
        // 远程下载URL配置
        private const val KPTOOLS_REMOTE_URL = "https://raw.githubusercontent.com/ShirkNeko/ZukiSU_patch/refs/heads/main/kpm/kptools"
        private const val KPIMG_REMOTE_URL = "https://raw.githubusercontent.com/ShirkNeko/ZukiSU_patch/refs/heads/main/kpm/kpimg"
    ...
    private suspend fun downloadFromRemote(
        ...
        try {
            connection = (URL(remoteUrl).openConnection() as HttpURLConnection).apply {
                ...
                requestMethod = "GET"
                setRequestProperty("User-Agent", "ZukiSU-KPM-Downloader/1.0")

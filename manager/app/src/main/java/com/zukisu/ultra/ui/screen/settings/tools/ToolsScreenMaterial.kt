package com.zukisu.ultra.ui.screen.settings.tools
                ...
                KsuIsValid {
                    ...
                    SegmentedColumn(
                        ...
                        content = listOf({
                            ...
                            val shizukuLabel = "Shizuku"
                            SegmentedListItem(
                                onClick = actions.onNavigateToShizuku,
                                headlineContent = { Text(shizukuLabel) },
                                supportingContent = { Text("Manage Shizuku server and authorizations") },
                                leadingContent = {
                                    Icon(
                                        Icons.Rounded.Hub,
                                        shizukuLabel,

...
lateinit var ksuApp: ZukiSUApplication

class ZukiSUApplication : Application(), ViewModelStoreOwner {
                ...
                .addInterceptor { block ->
                    block.proceed(
                        block.request().newBuilder()
                            .header("User-Agent", "ZukiSU/${BuildConfig.VERSION_CODE}")

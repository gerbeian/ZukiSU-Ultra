...
val defaultManagerPackageName = if (isPrBuild) "com.zukisu.ultra.pr" else "com.zukisu.ultra"
val defaultManagerName = if (isPrBuild) "ZukiSU PR" else "ZukiSU"
